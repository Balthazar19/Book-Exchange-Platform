...
public class PublicationCreationWindow implements Initializable {

    @FXML
    public ListView<Publication> ownedPublicationsListField;
    @FXML
    ...
    public void fillPublicationList() {
        ownedPublicationsListField.getItems().clear();
        List<Publication> publicationsList = hibernate.getAllRecords(Publication.class);
        publicationsList.removeIf(publication -> publication.getOwner().getId() != currentUser.getId());
        ownedPublicationsListField.getItems().addAll(publicationsList);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        setCurrentUser(Main.currentUser);
        fillPublicationList();
    }
    ...
    public void createNewPublication() {
        if (currentUser instanceof Client) {
            ...
            publication.setPublicationStatus(PublicationStatus.UNAVAILABLE);
    ...
    public void loadPublisherData() {
        Publication selectedPub = ownedPublicationsListField.getSelectionModel().getSelectedItem();
